...
class SitemapController extends Controller
{
    ...
    public function sitemapAction(Request $request)
    {
        ...
        $urls[] = ['loc' =>
            $this->get('router')->generate('about_us',array('locale' => $locale, '_locale' => $locale)), 'changefreq' => 'weekly', 'priority' => '1.0'
        ];
        $urls[] = ['loc' =>
            $this->get('router')->generate('faq_page',array('locale' => $locale, '_locale' => $locale)), 'changefreq' => 'weekly', 'priority' => '1.0'
        ];

        $urls[] = ['loc' =>
            $this->get('router')->generate('privacy_page',array('locale' => $locale, '_locale' => $locale)), 'changefreq' => 'weekly', 'priority' => '1.0'
        ];
        ...
        $offers = $offerRepository->findBy(array('archived' => 0, 'validated' => 1));
